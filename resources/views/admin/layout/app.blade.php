...
<head>
    ...
    <link href="{{ asset('assets/admin/vendor/bootstrap-datepicker-master/css/bootstrap-datepicker.min.css') }}" rel="stylesheet">
    <link href="{{ asset('assets/admin/vendor/dropzone/dist/dropzone.css') }}" rel="stylesheet">
    <link href="{{ asset('assets/admin/css/style.css') }}" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/1.13.4/css/dataTables.bootstrap5.min.css">
    <style>
        /* === DataTables Global Fixes === */

        /* Fix header alignment when scrollY is used */
...
<body >
    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        <!--**********************************
            Nav header start
        ***********************************-->
        <div class="nav-header" style="background-color: #ffffffff;">
            <a href="{{ route('admin.dashboard') }}" class="brand-logo">
                <!-- <img class="logo-abbr" src="{{ asset('assets/images/logo.svg') }}" alt="/"> -->
                <!-- <img class="logo-compact" src="{{ asset('assets/images/logo.svg') }}" alt="/"> -->
                <img class="brand-title" src="{{ asset('assets/images/Asha_logo.png') }}" alt="aasha city logo">
            </a>
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="#" target="_blank">Suchit Mishra</a> {{ date('Y') }}</p>
            </div>
        </div>
        <!--**********************************
            Footer end
    ...
    ***********************************-->
    ...
    <!-- Dashboard 1 -->
	<script src="{{ asset('assets/admin/vendor/lightgallery/dist/lightgallery.min.js') }}"></script>
	<script src="{{ asset('assets/admin/vendor/lightgallery/dist/plugins/thumbnail/lg-thumbnail.min.js') }}"></script>
	<script src="{{ asset('assets/admin/vendor/lightgallery/dist/plugins/zoom/lg-zoom.min.js') }}"></script>
    <!-- Datatable -->
    ...
    <script src="{{ asset('assets/admin/vendor/dropzone/dist/dropzone.js') }}"></script>
	<script src="{{ asset('assets/admin/js/dashboard/cms.js') }}"></script>
...
$(document).ready(function() {
    ...
    // Filters trigger DataTable reload
    $('#filter-name, #filter-phone, #filter-status').on('keyup change', function() {
        table.draw();
    });
    ...
    <script>
        $(document).ready(function() {
            // Adjust all DataTables on window resize
            $(window).on('resize', function() {
                $.fn.dataTable.tables({ visible: true, api: true }).columns.adjust();
            });

            // Adjust DataTables when a bootstrap tab is shown

...
<div class="content-body">
    <div class="container-fluid">
        <div class="form-head page-titles d-flex align-items-center mb-4">
            <div class="me-auto">
                <h4 class="mb-1">Add New Sub-Admin / Employer</h4>
                <ol class="breadcrumb">
            ...
            <div class="col-xl-8 col-lg-10 mx-auto">
                ...
                <div class="card-form">
                    <div class="card-form-header">
                        <h4>Create Account & Assign Permissions</h4>
                    </div>
                        ...
                        <form action="{{ route('admin.sub-admins.store') }}" method="POST">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-lg-4 mb-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="permissions[]" value="{{ $slug }}" id="perm_{{ $slug }}" {{ is_array(old('permissions')) && in_array($slug, old('permissions')) ? 'checked' : '' }}>
                            ...
                            <div class="d-flex justify-content-start gap-2">
                                <button type="submit" class="btn btn-primary" style="background-color:#143642; border-color:#143642;">
                                    <i class="fa fa-check me-1"></i> Create Sub-Admin
                                </button>
